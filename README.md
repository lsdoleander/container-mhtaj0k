...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-mhtaj0k.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-mhtaj0k.containers.anotherwebservice.com/
...
```
git clone git@github.com:lsdoleander/container-mhtaj0k.git
cd container-mhtaj0k
```
...
```
docker attach container-mhtaj0k
```
